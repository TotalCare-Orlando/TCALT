...
You should have your username and password on your email. If you forgot, lost, is having issues logging in, or would like to change your password,
...
Ex.: Let's lookup the address '123 This Street'.
	...
	Try typing '123 This', for a much better accuracy in your search.

You may also search by member name. Keep in mind that only FIVE results will be shown at a time,
so if our member has multiple homes, or is a common name, it is advised that you search by address instead.

Ex.: Let's look up the name 'Jonathan Doe'.

	If you type 'Joh' you may not find the name you were looking for.
	Try typing 'Jonathan', or search the address for better results.
